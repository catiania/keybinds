...
function update() {
    ...
    if ((oldTargetNum != targetNum && onSheet())) {
        ...
        console.log("hi")
        var targetNums = Array.from(document.querySelectorAll('a')).filter(a => a.textContent === "target" || a.textContent === "Target");
    ...
    if ((oldTarget != target && onSheet())) {
        oldTarget = target;
        var targets = Array.from(document.querySelectorAll('a')).filter(a => a.textContent === "target" || a.textContent === "Target");
